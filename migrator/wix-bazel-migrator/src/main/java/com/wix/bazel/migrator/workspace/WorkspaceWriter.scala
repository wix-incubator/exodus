  ...
  def write(): Unit = {
    val workspaceFileContents =
      s"""
         ...
         |rules_scala_version="11558c88fa72661a4d2521080dbed4b1b0bcaceb" # update this as needed
         |
         |http_archive(
         ...
         |             sha256 = "f5cf3df84d13a9cc029ead992435450f622f30a68fa812fac81625282052ae96",
         |)
         |
